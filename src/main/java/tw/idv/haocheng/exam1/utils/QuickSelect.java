 ...
 * {@link http://www.java-tips.org/java-se-tips/java.lang/quickselect-implementation-with-median-of-three-partitioning-and-cutoff.html}
 * 
 * @author haocheng
 * 
 */
public class QuickSelect {
	 ...
	 */
	public static void quickSelect(Integer[] a, int k) {
	 ...
	 *            the desired rank (1 is minimum) in the entire array.
	 */
	private static void quickSelect(Integer[] a, int low, int high, int k) {
		if (low + CUTOFF > high)
